...
![Screenshot of Auto Fishing GUI](/assets/example.png)
...
> [!IMPORTANT]
> The program waits 5 seconds to allow NTE to be focused. Start an Auto-Clicker after the program, otherwise the Auto Fishing isn't truly afk.
